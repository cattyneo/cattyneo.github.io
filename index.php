...
<html lang="ja">
    <head>
        ...
        <meta name="description" content="Webデザイナー 高橋直秀のポートフォリオサイトです。熊本を中心に活動しています。">
    ...
    <body>
        <header>
            ...
            <div class="profile">
                <h1 class="site-title abel uppercase text-center">Web Designer <span>Naohide Takahashi</span></h1>
                <img src="./images/img_profile.jpg" alt="プロフィール写真" width="140" height="140" class="block-center profile-icon">
                <p>熊本県在住のWebデザイナー、高橋直秀です。Web制作を通じて表現力を高め、様々な分野で活動するクリエイターになりたいと思っております。</p>
            </div>
        </header>
        <main>
            ...
            <section id="skills">
                ...
                <div class="container">
                    <div class="skill-box">
                        ...
                        <p>HTML5/PHPでのコーディングができます。WordPressも現在勉強中です。</p>
                    </div>
                    <div class="skill-box">
                        <i aria-hidden="true" class="skill-icon fa fa-gears"></i>
                        <h3 class="text-center">UWSC</h3>
                        <p>Windows自動操作ソフト「UWSC」を使用し、PCのあらゆる単純作業を自動化させることができます。</p>
                    </div>
                    <div class="skill-box">
                        <i aria-hidden="true" class="skill-icon fa fa-commenting-o"></i>
                        <h3 class="text-center">English</h3>
                        <p>カナダに短期留学した経験があり、英語が得意です。Webデザインも海外の記事を読んで勉強しています。</p>
                    </div>
                </div>
            </section>
            ...
            <section id="works">
                ...
                <div class="works-box">
                    <a href="#">
                        <img src="./images/img_work_site.jpg" alt="株式会社きらめき コーポレートサイト様 Webサイトデザイン">
                        <div class="works-box-inner">
                            <div class="text-center">
                                <h3>株式会社きらめき コーポレートサイト</h3>
                ...
                <div class="works-box">
                    <a href="#">
                        <img src="./images/img_work_card.jpg" alt="きらめき花子様 名刺デザイン">
                        <div class="works-box-inner">
                            <div class="text-center">
                                <h3>きらめき花子様 名刺</h3>
                                <small>2016.04.20</small>
            ...
            <section id="contact">
                ...
                <ul>
                    ...
                    <li class="github"><a href="https://github.com/cattyneo"><i aria-label="GitHub" class="fa fa-github"></i></a></li>
                    <li class="facebook"><a href="https://www.facebook.com/naohide.t"><i aria-label="Facebook" class="fa fa-facebook-square"></i></a></li>
                </ul>
            </section>
        </main>
        <footer>
